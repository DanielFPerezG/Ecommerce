    ...
    html:
      ...
      '">' +
        ...
        '<div style="' +
          (isMobile ? '' : 'flex: 1;') +
        '">' +
        '<img src="images/logo/daviplata.png" alt="Daviplata" class="img-fluid payment-logo rounded" style="max-width: 30%; height: auto; max-height: 81.05px; float: right; clear: right;">' +
